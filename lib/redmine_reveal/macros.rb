...
EOF
            macro :slideSetup do |obj, args|
                ...
                obj.slide_options.transition            = RedmineReveal::Macros.getTransition(obj, options[:transition])
                obj.slide_options.speed                 = RedmineReveal::Macros.getSpeed(obj, options[:speed])
                obj.slide_options.background_color      = RedmineReveal::Macros.getBackgroundColor(obj, options[:background_color])
                obj.slide_options.background_image      = RedmineReveal::Macros.getBackgroundImage(obj, options[:background_image])
                obj.slide_options.background_size       = RedmineReveal::Macros.getBackgroundSize(obj, options[:background_size])
                obj.slide_options.background_position   = RedmineReveal::Macros.getBackgroundPosition(obj, options[:background_position])
                obj.slide_options.background_repeat     = RedmineReveal::Macros.getBackgroundRepeat(obj, options[:background_repeat])
...
EOF
        ...
        class << self
            ...
            def slide_options(obj, options)
                transition            = RedmineReveal::Macros.getTransition(obj, options[:transition])
                speed                 = RedmineReveal::Macros.getSpeed(obj, options[:speed])
                background_color      = RedmineReveal::Macros.getBackgroundColor(obj, options[:background_color])
                background_image      = RedmineReveal::Macros.getBackgroundImage(obj, options[:background_image])
                background_size       = RedmineReveal::Macros.getBackgroundSize(obj, options[:background_size])
                background_position   = RedmineReveal::Macros.getBackgroundPosition(obj, options[:background_position])
                background_repeat     = RedmineReveal::Macros.getBackgroundRepeat(obj, options[:background_repeat])
                background_transition = RedmineReveal::Macros.getBackgroundTransition(obj, options[:background_transition])
            ...
            def getTransition(obj, value)
                ...
                return RedmineReveal::Macros.getTransition1(obj, values[0]) if values.length < 2
                
                transitionIn  = RedmineReveal::Macros.getTransition1(obj, values[0])
                transitionOut = RedmineReveal::Macros.getTransition1(obj, values[1])
            ...
            #     default = obj.slide_options.transition
                ...
                RedmineReveal::Macros.check_transition value, obj.slide_options.transition
            #     return default if value.blank?
            ...
            def getBackgroundTransition(obj, value)
                RedmineReveal::Macros.check_transition value, obj.slide_options.background_transition
            end
